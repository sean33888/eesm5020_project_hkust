...
void  rmaPropagate25_s0_simv_daidir (UB  * pcode, scalar  val);
...
void  rmaPropagate33_s0_simv_daidir (UB  * pcode, scalar  val);
...
void  rmaPropagate40_s0_simv_daidir (UB  * pcode, scalar  val);
...
void  rmaPropagate60_f_simv_daidir (UB  * pcode, scalar  val, U  I619, scalar  * I1441, U  did);
...
void  rmaPropagate61_f_simv_daidir (UB  * pcode, scalar  val, U  I619, scalar  * I1441, U  did);
...
void  rmaPropagate62_f_simv_daidir (UB  * pcode, scalar  val, U  I619, scalar  * I1441, U  did);
...
void  rmaPropagate63_f_simv_daidir (UB  * pcode, scalar  val, U  I619, scalar  * I1441, U  did);
...
void  rmaPropagate64_f_simv_daidir (UB  * pcode, scalar  val, U  I619, scalar  * I1441, U  did);
...
void  rmaPropagate66_f_simv_daidir (UB  * pcode, scalar  val, U  I619, scalar  * I1441, U  did);
...
void  rmaPropagate67_f_simv_daidir (UB  * pcode, scalar  val, U  I619, scalar  * I1441, U  did);
...
void  rmaPropagate68_f_simv_daidir (UB  * pcode, scalar  val, U  I619, scalar  * I1441, U  did);
...
void  rmaPropagate69_f_simv_daidir (UB  * pcode, scalar  val, U  I619, scalar  * I1441, U  did);
void  rmaPropagate69_r_simv_daidir (UB  * pcode);
void  rmaPropagate70_p_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate70_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate70_f_simv_daidir (UB  * pcode, scalar  val, U  I619, scalar  * I1441, U  did);
void  rmaPropagate70_r_simv_daidir (UB  * pcode);
void  rmaPropagate70_s0_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate71_p_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate71_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate71_f_simv_daidir (UB  * pcode, scalar  val, U  I619, scalar  * I1441, U  did);
void  rmaPropagate71_r_simv_daidir (UB  * pcode);
void  rmaPropagate107_p_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate107_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate107_f_simv_daidir (UB  * pcode, scalar  val, U  I619, scalar  * I1441, U  did);
void  rmaPropagate107_r_simv_daidir (UB  * pcode);
void  rmaPropagate108_p_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate108_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate108_f_simv_daidir (UB  * pcode, scalar  val, U  I619, scalar  * I1441, U  did);
void  rmaPropagate108_r_simv_daidir (UB  * pcode);
void  rmaPropagate109_p_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate109_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate109_f_simv_daidir (UB  * pcode, scalar  val, U  I619, scalar  * I1441, U  did);
void  rmaPropagate109_r_simv_daidir (UB  * pcode);
void  rmaPropagate110_p_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate110_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate110_f_simv_daidir (UB  * pcode, scalar  val, U  I619, scalar  * I1441, U  did);
void  rmaPropagate110_r_simv_daidir (UB  * pcode);
void  rmaPropagate111_p_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate111_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate111_f_simv_daidir (UB  * pcode, scalar  val, U  I619, scalar  * I1441, U  did);
void  rmaPropagate111_r_simv_daidir (UB  * pcode);
void  rmaPropagate112_p_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate112_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate112_f_simv_daidir (UB  * pcode, scalar  val, U  I619, scalar  * I1441, U  did);
void  rmaPropagate112_r_simv_daidir (UB  * pcode);
void  rmaPropagate113_p_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate113_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate113_f_simv_daidir (UB  * pcode, scalar  val, U  I619, scalar  * I1441, U  did);
void  rmaPropagate113_r_simv_daidir (UB  * pcode);
void  rmaPropagate114_p_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate114_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate114_f_simv_daidir (UB  * pcode, scalar  val, U  I619, scalar  * I1441, U  did);
void  rmaPropagate114_r_simv_daidir (UB  * pcode);
void  rmaPropagate116_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate119_p_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate119_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate119_f_simv_daidir (UB  * pcode, scalar  val, U  I619, scalar  * I1441, U  did);
void  rmaPropagate119_r_simv_daidir (UB  * pcode);
void  rmaPropagate120_p_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate120_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate120_f_simv_daidir (UB  * pcode, scalar  val, U  I619, scalar  * I1441, U  did);
void  rmaPropagate120_r_simv_daidir (UB  * pcode);
...
void  rmaPropagate122_p_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate122_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate122_f_simv_daidir (UB  * pcode, scalar  val, U  I619, scalar  * I1441, U  did);
void  rmaPropagate122_r_simv_daidir (UB  * pcode);
void  rmaPropagate123_p_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate123_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate123_f_simv_daidir (UB  * pcode, scalar  val, U  I619, scalar  * I1441, U  did);
void  rmaPropagate123_r_simv_daidir (UB  * pcode);
void  rmaPropagate124_p_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate124_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate124_f_simv_daidir (UB  * pcode, scalar  val, U  I619, scalar  * I1441, U  did);
void  rmaPropagate124_r_simv_daidir (UB  * pcode);
void  rmaPropagate125_p_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate125_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate125_f_simv_daidir (UB  * pcode, scalar  val, U  I619, scalar  * I1441, U  did);
void  rmaPropagate125_r_simv_daidir (UB  * pcode);
void  rmaPropagate126_p_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate126_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate126_f_simv_daidir (UB  * pcode, scalar  val, U  I619, scalar  * I1441, U  did);
void  rmaPropagate126_r_simv_daidir (UB  * pcode);
void  rmaPropagate126_s0_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate127_p_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate127_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate127_f_simv_daidir (UB  * pcode, scalar  val, U  I619, scalar  * I1441, U  did);
...
void  rmaPropagate130_f_simv_daidir (UB  * pcode, scalar  val, U  I619, scalar  * I1441, U  did);
...
void  rmaPropagate131_f_simv_daidir (UB  * pcode, scalar  val, U  I619, scalar  * I1441, U  did);
void  rmaPropagate131_r_simv_daidir (UB  * pcode);
void  rmaPropagate131_wn_simv_daidir (UB  * pcode, scalar  val);
...
void  rmaPropagate136_f_simv_daidir (UB  * pcode, scalar  val, U  I619, scalar  * I1441, U  did);
void  rmaPropagate136_r_simv_daidir (UB  * pcode);
void  rmaPropagate138_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate139_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate141_p_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate141_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate141_f_simv_daidir (UB  * pcode, scalar  val, U  I619, scalar  * I1441, U  did);
